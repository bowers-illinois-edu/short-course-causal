...
\item How would you estimate and interpret the average effect of the intervention on one of the outcomes
  of your choice using R? If you are using \texttt{hom}, I would advise using
