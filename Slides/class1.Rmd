...
So: (1)  experiments do not guarantee exact equality of covariates and (2) we
can **know** (or closely approximate) what kind of covariate differences a
given experimental design would generate.
