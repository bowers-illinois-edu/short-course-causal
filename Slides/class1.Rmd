...
We can learn about causal claims by observing [@brady2008causation]:
...
honeydat$id <- 1:10
dat <- honeydat[,c("id","y0","y1","tau")]
```

Imagine these were the underlying potential outcomes:
...
How might we estimate the average causal effect?
