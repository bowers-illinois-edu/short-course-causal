...
## So far:
 ...
 1. Introduced non-bipartite matching (see also DOS on Risk Set Matching and Longitudinal Applications)
 2. New questions arose:
    1. How to encourage pairs to **differ** in the causal/explanatory variable. (use the `far` option in `nmatch`).
    2. What does "balance" mean in this case? Does it compare to an experiment in some way? Which experiment?
    3. How to think about effects: should it just be higher-vs-lower? Or more-versus-less?
