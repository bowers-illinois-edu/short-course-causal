...
## Doing Matching, Assessing Designs, Estimating Effects
  ...
  3. **Balance assessment after non-bipartite matching.** Multivariate balance
     assessment using null hypothesis testing (and using equivalence testing).
  4. **Focusing and customizing non-bipartite matched designs** Decisions and
     ...
     scalar distances)
  5. **Statistical inference after non-bipartite matching** Estimating ATE and
     Std Errors from Matched Designs using the Block Randomized Experiment as
     an Analogy.
