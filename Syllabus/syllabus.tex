...
\titleformat{\section}[hang]{\large\bfseries}{\hspace{-.75in}\thesection ---}{.25em}{}{}
...
\maketitle
  ...
  This class is an introduction to statistical adjustment using matched stratification
  in the style pioneered by Rubin and Rosenbaum
  and currently in rapid development across
